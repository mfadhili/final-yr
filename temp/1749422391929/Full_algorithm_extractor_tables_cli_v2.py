...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run all MPPT algorithms with custom population size and iteration count"
    )
    parser.add_argument(
        "--pop_size", "-p",
        type=int, default=30,
...
def main():
    args = parse_args()
    global pop_size, max_iter, num_particles, num_food_sources, num_locusts, hm_size, n_nests
